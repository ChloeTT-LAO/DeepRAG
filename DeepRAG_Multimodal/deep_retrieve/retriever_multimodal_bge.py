...
class MultimodalMatcher:
    ...
    def _setup_models(self):
        qwen_model_dir = "/Users/chloe/Documents/Academic/AI/Project/基于Colpali的多模态检索标准框架/multimodal-RAG/local_models/models--vidore--colqwen2.5-v0.2/snapshots/69c1b67febf7defef4f3000c858d8700e870c6aa"
        self.text_tokenizer = AutoTokenizer.from_pretrained(self.config.bge_model_name, use_fast=True)
        self.text_model = AutoModel.from_pretrained(self.config.bge_model_name).to("cpu")
    ...
    def _pdf_to_pages(self, pdf_path: str) -> List[dict]:
        ...
        """
        parent_dir = '/Users/chloe/Documents/Academic/AI/Project/基于Colpali的多模态检索标准框架/multimodal-RAG/DeepRAG_Multimodal/picked_LongDoc/paddleocr_save'
    ...
    def _compute_text_score(self, query: str, text: str) -> float:
        ...
        text_tokens = self.text_tokenizer(text, padding=True, truncation=True, return_tensors="pt", max_length=512).to("cpu")
        with torch.no_grad():
    ...
    def _compute_image_score(self, query: str, image: Optional[Image.Image]) -> float:
        ...
        with torch.no_grad():
            ...
            image_input = self.processor.process_images([img_copy]).to(self.image_model.device)
